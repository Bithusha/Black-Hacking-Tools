...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m Edited By \e[1;32mSL Phone Technician \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border TBomb
    fi
    echo -e "\e[1;34m join for more hacking tools!\e[0m"
    echo -e "\e[1;32m           WhatsApp: https://chat.whatsapp.com/CsXyKtoCFAX6H7ybn6q7mh "
    echo -e "\e[4;32m   Subscribe to see videos: https://www.youtube.com/channel/UCLSPyq4TDqgBaKYgyx0ASrg \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo edited help by Bithusha > .update
